...
class Net(nn.Module):
    def __init__(self):
        ...
        self.conv1 = ConvDrop_ACGAN(3, 16, 3, 2, 1, bn=False)
        self.conv2 = ConvDrop_ACGAN(16, 32, 3, 1, 0)
        self.conv3 = ConvDrop_ACGAN(32, 64, 3, 2, 1)
        self.conv4 = ConvDrop_ACGAN(64, 128, 3, 1, 0)
        self.conv5 = ConvDrop_ACGAN(128, 256, 3, 2, 1)
        self.conv6 = ConvDrop_ACGAN(256, 512, 3, 1, 0)
